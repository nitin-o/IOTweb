...
const CreateAccount = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Account created for ${fullName}! (Demo mode)`);
  };
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950/40 to-purple-950/30 text-white">
      {/* Animations (same as welcome & login) */}
      <style>
        {`
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Join the smart home revolution</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-6 md:p-8 shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-indigo-600 hover:bg-indigo-500 transform hover:scale-[1.02] transition-all duration-300 py-3 rounded-xl text-white font-semibold shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2 mt-2"
              >
